...
function addprogress()
{
	...
	if ($db->query($sql) === TRUE) {
		...
		echo "if(!alert('Record succesfully updated')){window.location.href = '../admin/add progress.php'}";  
		echo '</script>';
	} else {
    	echo '<script language="javascript">';
		echo "if(!alert('Record failed to write: Contact your software provider')){window.location.href = '../admin/add progress.php'}";  
		echo '</script>';
	}
}
...
function updateprogress()
{
	...
	if ($db->query($sql) === TRUE) {
		...
		echo '<script language="javascript">';
		echo "if(!alert('Record failed to update: Contact your application provider')){window.location.href = '../admin/add progress.php'}";  
		echo '</script>';
	}
}
